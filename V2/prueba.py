...
layout = [[sg.Text('Date Chooser Test Harness', key='-TXT-')],
      ...
      [sg.Input(key='-IN2-', size=(20,1)), sg.CalendarButton('Cal German Feb 2020',  target='-IN2-',  default_date_m_d_y=(2,None,2020), format='20%y-%m-%d',locale='de_DE', begin_at_sunday_plus=1 )],
